...
const Volunteering = ({ setVolunteeringData }) => {
  ...
  const deleteComponent = (id) => {
    ...
    setComponents(updatedComponents);
    setVolunteeringData(updatedComponents)
  };
        ...
        {components.map((component, index) => (
          ...
          >
            <div className={`py-5 w-full flex justify-between`}>
              ...
              >
                <p>
                  {component.organisation_name} {component.volunteering_title}{" "}
                </p>
                          ...
                          <div className="grid justify-start grid-cols-2 gap-6">
                            <div className="mb-4">
                              <Label
                                ...
                                forHtml="organisation_name"
                              />
                              <Input
                                name={"organisation_name"}
                                componentId={component.id}
                                value={component.organisation_name}
                            ...
                            <div className="mb-4">
                              <Label
                                ...
                                forHtml="volunteering_title"
                              />
                              <Input
                                name={"volunteering_title"}
                                componentId={component.id}
                                value={component.volunteering_title}
                                handleInputChange={handleInputChange}
                              />
                            </div>
                            <div className="mb-4">
